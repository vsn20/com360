...
const InvoiceOverview = () => {
  ...
  // Auto-load saved invoices when filters change
  useEffect(() => {
    if (view === "saved") {
      handleLoadSavedInvoices();
    }
  }, [savedStartDate, savedEndDate, savedRecipientEmail, savedStatus]);
  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.header}>
        ...
        <button 
          className={styles.savedInvoicesBtn} 
      ...
      {view === "list" ? (
        ...
        <div className={styles.savedInvoicesContainer}>
          <div className={styles.savedHeader}>
            <h2 className={styles.savedTitle}>Saved Invoices</h2>
            <button className={styles.backBtn} onClick={() => setView("list")}>← Back to Generate</button>
          </div>
                    ...
                    <tr key={idx}>
                      ...
                      <td>
                        <span className={`${styles.statusBadge} ${
                          ...
                          invoice.STATUS === 'RESENT' ? styles.statusResent : 
                          styles.statusFailed
                        }`}>
                          {invoice.STATUS}
                        </span>
