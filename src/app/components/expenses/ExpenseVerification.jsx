...
const ExpenseVerification = ({ empid, orgid, error: initialError }) => {
  ...
  const handleUnverify = async () => {
    ...
    if (
      !confirm(
        "Are you sure you want to change this expense status back to pending? This will remove the verification."
      )
    ) {
      return;
    }
  ...
  // Replace the formatDateForDisplay function in ExpenseVerification.jsx with this:
          ...
          <div className={styles.headerSection}>
            ...
            <button
              className={`${styles.button} ${
                showPendingOnly ? styles.buttonSave : styles.buttonAdd
              }`}
            ...
            <div className={styles.formSection}>
              ...
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  <input
                    type="text"
                    value={`$${parseFloat(expenseDetails.AMOUNT || 0).toFixed(
                      2
                    )}`}
                    readOnly
                    disabled
                ...
                <div className={styles.formGroup}>
                  ...
                  <input
                    type="text"
                    value={`$${parseFloat(expenseDetails.TOTAL || 0).toFixed(
                      2
                    )}`}
                    readOnly
                    disabled
